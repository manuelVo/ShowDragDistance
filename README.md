# ShowDragDistance (manuelVo's fork)
...
# About this fork
This fork applies a few fixes to ShowDragDistance:
- Make ShowDragDistance compatible with game systems that don't use the 5/5/5 diagonal rule
- Show a ruler on gridless maps
- Respect the dash multiplier setting

# Changelog
2.2.3.2 - Show a ruler on gridless maps

2.2.3.1 - Make ShowDragDistance compatible with game systems that don't use the 5/5/5 diagonal rule, Respect the dash multiplier setting
